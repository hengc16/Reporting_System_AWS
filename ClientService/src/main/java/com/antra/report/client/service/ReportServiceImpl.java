...
//    @Transactional // why this? email could fail
    public void updateAsyncPDFReport(SqsResponse response) {
        ...
        String to = "hengtesttest@gmail.com";
...
//            InputStream is = restTemplate.execute(, HttpMethod.GET, null, ClientHttpResponse::getBody, fileId);
            ResponseEntity<Resource> exchange = restTemplate.exchange("http://excel-service/excel/{id}/content",
    ...
    public void deleteFile(String reqId) {
        ...
        try {
            rs.delete("http://excel-service/excel" + "/" + ExcelFileId);
            rs.delete("http://PDF-service/pdf" + "/" + PDFFileId);
