...
public class ReportController {
    ...
    public ResponseEntity<GeneralResponse> getFallbackReport(){
        log.info("circuit break, give default response");
        return  new ResponseEntity<>(new ErrorResponse(HttpStatus.BAD_REQUEST, "circuit break"), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<GeneralResponse> deleteFiles(@PathVariable String reqId) {
